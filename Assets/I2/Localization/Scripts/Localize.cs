...
namespace I2.Loc
{
    ...
    public partial class Localize : MonoBehaviour
    {
        ...
        void Awake()
		{
			...
			LocalizationManager.UpdateLocalizationParams();
		...
		public void OnLocalize(bool Force = false)
		{
			...
			if (LocalizationManager.localizationFormatBehaviour != null && AllowLocalizedParameters)
			{
				// This allows scripts to modify the translations :  e.g. "Player {0} wins"  ->  "Player Red wins"
				MainTranslation = LocalizationManager.localizationFormatBehaviour.SetFormat(this, stringParams);
			}
		...
		public void SetStringParams(params object[] _stringParams)
		{
			stringParams = _stringParams;
			OnLocalize(true);
		}

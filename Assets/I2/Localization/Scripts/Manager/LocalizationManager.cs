...
namespace I2.Loc
{
    public static partial class LocalizationManager
    {
        ...
        public static ILocalizationFormatBehaviour localizationFormatBehaviour = new SafeStringFormatBehaviour();
       
        private static bool isParamsUpdated = false;
        ...
        public static void UpdateLocalizationParams(bool forceUpdate = false)
        {
            if (forceUpdate || !isParamsUpdated)
            {
                LanguageSourceData source = Sources.FirstOrDefault();
                ...
                localizationFormatBehaviour = source.LocalizationFormatBehaviour;

...
namespace I2.Loc
{
    public static partial class LocalizationManager
    {
        ...
        static bool mChangeCultureInfo = true;
        ...
        private static bool useInvariantCultureAsDefault;
        ...
        public static void SetLanguageAndCode(string LanguageName, string LanguageCode, bool RememberLanguage = true, bool Force = false)
        {
            if (mCurrentLanguage != LanguageName || mLanguageCode != LanguageCode || Force)
            {
                ...
                useInvariantCultureAsDefault = Sources.FirstOrDefault().useInvariantCultureAsDefault;
        ...
        {
            if(useInvariantCultureAsDefault)
            {

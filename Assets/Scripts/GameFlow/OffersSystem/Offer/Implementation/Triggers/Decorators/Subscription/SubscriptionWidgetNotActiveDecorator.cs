...
{
    public class SubscriptionWidgetNotActiveDecorator : BaseOfferTriggerDecorator
    {
        #region Fields
        ...
        public SubscriptionWidgetNotActiveDecorator(IAbTestService _abTestService, BaseOfferTrigger _trigger) : base(_trigger)
        {

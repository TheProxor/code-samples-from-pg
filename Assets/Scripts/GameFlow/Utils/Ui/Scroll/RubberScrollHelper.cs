...
namespace Drawmasters.Utils.Ui
{
    ...
    /// Editing this script, don't forget also to edit ScrollHelper.cs as there are not general interface for ScrollRect
    /// </summary>
    public class RubberScrollHelper : IScrollHelper
    {
        #region Fields

        private readonly RubberScrollRect scrollRect;
        ...
        public Vector3 ScrollBottomPosition
        {
            get
            {
                ...
                float contentOffset = scrollRect.content.rect.height - (scrollRect.transform as RectTransform).rect.height;
        ...
        public RubberScrollHelper(RubberScrollRect _scrollRect, Canvas _mainCanvas, EventTrigger _eventTrigger = null)
        {
        ...
        public void Scroll(Vector3 beginPosition, Vector3 endPosition, VectorAnimation animation, object handler, Action callback = default, Action<Vector3> onScroll = default)
        {
            ...
            {
                scrollRect.content.anchoredPosition3D = value;
